...
f = open('./output/kmeans-fenci.txt', 'w', encoding='utf-8-sig')
for line in tqdm(df['comment']):
...
corpus = []
# 读取预料 一行预料为一个文档
for line in open('./output/kmeans-fenci.txt', 'r',encoding='utf-8-sig').readlines():
...
result.to_csv('./output/聚类结果.csv',encoding="utf-8-sig")
