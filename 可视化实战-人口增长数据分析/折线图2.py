...
df = pd.read_excel('dates.xls').loc[49:55,['2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019']]
...
c =(
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(title="建成区绿化覆盖率_市辖区"),
